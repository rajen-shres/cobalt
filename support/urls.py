...
urlpatterns = [
    ...
    path("helpdesk/user-edit/<int:ticket_id>", helpdesk.user_edit_ticket, name="helpdesk_user_edit"),
    path("helpdesk/attachments/<int:ticket_id>", helpdesk.helpdesk_attachments, name="helpdesk_attachments"),
    path("helpdesk-ajax-delete-attachment", helpdesk.helpdesk_delete_attachment_ajax, name="helpdesk_delete_attachment_ajax"),
    path(
