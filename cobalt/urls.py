...
urlpatterns = (
    [
        ...
        path(
            "organisations/", include("organisations.urls", namespace="organisations")
        ),
    ...
    + [
        # slug must come last - will try to match anything to a short name and redirect
        path("<str:slug_name>/", slug, name="slug"),
    ]
)
